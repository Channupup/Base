...
SC_MODULE(NoximVLink)
{
    ...
    sc_out  <bool>       req_rx_to_UP[DEFAULT_MESH_DIM_Z-1] ;	// The requests associated with the input channels
    //req_rx_to_UP = new sc_out  <bool>[NoximGlobalParams::mesh_dim_z - 1];
    sc_in   <bool>       ack_rx_to_UP[DEFAULT_MESH_DIM_Z-1] ;	// The outgoing ack signals associated with the input channels
    ...
    sc_in  <bool>       req_tx_to_UP[DEFAULT_MESH_DIM_Z-1] ;	// The requests associated with the input channels
    //req_tx_to_UP = new sc_in  <bool>[NoximGlobalParams::mesh_dim_z - 1];
    sc_out <bool>       ack_tx_to_UP[DEFAULT_MESH_DIM_Z-1] ;	// The outgoing ack signals associated with the input channels
    ...
    sc_in  <bool>       req_rx_to_DOWN[DEFAULT_MESH_DIM_Z-1] ;        // The requests associated with the output channels
    //req_rx_to_DOWN = new sc_in  <bool>[NoximGlobalParams::mesh_dim_z - 1];
    sc_out <bool>       ack_rx_to_DOWN[DEFAULT_MESH_DIM_Z-1] ;	        // The outgoing ack signals associated with the output channels
    ...
    sc_out <bool>       req_tx_to_DOWN[DEFAULT_MESH_DIM_Z-1] ;	        // The requests associated with the output channels
    //req_tx_to_DOWN = new sc_out  <bool>[NoximGlobalParams::mesh_dim_z - 1];
    sc_in  <bool>       ack_tx_to_DOWN[DEFAULT_MESH_DIM_Z-1] ;	        // The outgoing ack signals associated with the output channels
    //ack_tx_to_DOWN = new sc_in  <bool>[NoximGlobalParams::mesh_dim_z - 1];

    //Signal
	sc_signal <bool>      req_rx [DEFAULT_MESH_DIM_Z-1];
	sc_signal <bool>      req_tx [DEFAULT_MESH_DIM_Z-1];
	sc_signal <bool>      ack_rx [DEFAULT_MESH_DIM_Z-1];
	sc_signal <bool>      ack_tx [DEFAULT_MESH_DIM_Z-1];
